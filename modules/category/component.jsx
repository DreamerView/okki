...
const CategoryList = ({lang,category}) => {
    return(all.filter(e=>e.category===category).map((e,index)=>index%2===0?<SubAppList key={index} lang={lang} category={e.name} />:<SubAppStore key={index} lang={lang} category={e.name} />))
};
