    ...
    return(
        ...
        <div className="main__app_info_banner">
            <div className="main__app_info_banner_block">
                <p className="small">{ux['rating'][lang]}</p>
                <h1>5.0</h1>
                <p className="small">★★★★★</p>
            </div>
            <div className="main__app_info_banner_block">
                <p className="small">{ux['language'][lang]}</p>
                <h1>{lang}</h1>
                <p className="small">+ 2 {ux['more'][lang]}</p>
            </div>
            <div className="main__app_info_banner_block">
                <p className="small">{ux['developer'][lang]}</p>
            ...
            <div className="main__app_info_banner_block">
                <p className="small">{ux['release'][lang]}</p>
