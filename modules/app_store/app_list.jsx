...
const AppList = ({lang,category,search,service,ux}) => {
    ...
    return(
        <div className={styles!==undefined&&styles.main__index_b}>
              ...
              <div className={`${styles!==undefined&&styles.main__index_block_row} box-inner apps_list`} ref={banner}>
                {service['list']&&service['list'].filter(e=>{return( category!==undefined?e.type === 'services' &&JSON.parse(e.category).includes(search):e.type === 'services')}).reverse().map((e,index)=>
