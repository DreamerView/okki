const AppStorePreloader = () => 
<div className="app_show_preloader">
    ...
    <g transform="rotate(0 50 50)">
        <rect className="app_show_svg" x={47} y={24} rx={3} ry={6} width={6} height={12} fill="#fe718d">
...
export default AppStorePreloader;