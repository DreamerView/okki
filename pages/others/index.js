...
const HealthIndex = ({lang}) => {
    ...
    return(
        <>
            ...
            <h1 className="flex_text">{nav_translate["others"][lang]} <div className="emoji_h1"><Image title={'Microsoft laptop emoji (Used for informational purposes only)'} priority src={"/emoji-small/laptop.webp"} width={26} height={26} alt="emoji"/></div></h1>
            <p className="sub_content">{translate["step0_description"][lang]}</p>
            <AppList lang={lang} category={"category"} search={"others"} />
            <AppStore category="others" lang={lang} />
            </div>
